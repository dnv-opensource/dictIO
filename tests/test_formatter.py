...
class TestCppFormatter:
    ...
    def run_block_comment_tests(
        ...
        # Prepare
        cpp_dict.block_comments = {101: as_is_block_comment}
        str_in = placeholder1 + "\n" + str_in_template
        str_expected = str_in.replace(placeholder1, as_is_block_comment)
        # Execute
        str_out = formatter.insert_block_comments(cpp_dict, str_in)
        # Assert
        assert str_out == str_expected

        # FALLBACK CASE: The dictionary contains 0 (NO) BLOCK COMMENT
        # Prepare
        cpp_dict.block_comments = {}
        ...
        cpp_dict.block_comments = {101: block_comment_tampered}
        str_in = placeholder1 + "\n" + str_in_template
    ...
    def test_insert_includes(self) -> None:
        ...
        formatter = CppFormatter()
        # Execute
        str_out = formatter.insert_includes(cpp_dict, str_in)
        # Assert
        assert str_out == str_expected
    ...
    def test_insert_line_comments(self) -> None:
        ...
        formatter = CppFormatter()
        str_in_template = formatter.format_dict(cpp_dict.data)
        cpp_dict.line_comments = {103: line_comment_in}
        placeholder1 = "BLOCKCOMMENT000101            BLOCKCOMMENT000101;"
        ...
        # Execute
        str_out = formatter.insert_line_comments(cpp_dict, str_in)
        # Assert
        assert str_out == str_expected
...
class TestFoamFormatter:
    ...
    def test_insert_includes(self) -> None:
        ...
        formatter = FoamFormatter()
        # Execute
        str_out: str = formatter.insert_includes(cpp_dict, str_in)
        # Assert
        assert str_out == str_expected
